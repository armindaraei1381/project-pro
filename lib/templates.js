 ...
 *
 * Each template describes a set of folders and files. File contents can
 * be a plain string or a function receiving the project name (useful for
 * injecting the name into generated files, e.g. package.json).
 */
 ...
 * @returns {string} e.g. "My App!" -> "my-app"
 */
 ...
 * @returns {Object} the template, or the "empty" template as fallback
 */
 ...
 * @param {string} projectPath destination folder (must exist)
 * @param {string} projectName raw project name (passed to content functions)
 */
