 ...
 * @returns {string} e.g. "just now", "5m ago", "2d ago", or a locale date
 */
 ...
 * @param {number} [maxSegments=3] how many trailing segments to keep
 * @returns {string} shortened path, e.g. "…/home/user/project"
 */
